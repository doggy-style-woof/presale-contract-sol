...
import {connection, program as solProgram, usdcKp, usdtKp, vaultKp} from "./utils/config";
import {createMints} from "./utils/create-mints";
import {airdropToken} from "./utils/airdrop-tokens";
...
const vaultPublicAddress: string = 'DaknMqDa4AoFZDZZzHAxWUXK4srVKkhG71Ns7Yu4eM3e'; // DAO address
